function prepare_animation(parameters)
    figure(1)
    
    %Plot parameters
    xmax=3;
    xmin=-xmax;
    ymin=xmax*tan(parameters.alfaA)-1;
    ymax=(parameters.L1F+parameters.L1T)*cos(parameters.alfaA)+1;
...
%     subplot(2,1,1)
    %Plot background
    x1_axis=line([-xmax,xmax],[-xmax*tan(parameters.alfaA),xmax*tan(parameters.alfaA)],'Color',[0.7,0.7,0.7]) ;
    y1_axis=line([0,-xmax*tan(parameters.alfaA)],[0,ymax],'Color',[0.7,0.7,0.7]);
