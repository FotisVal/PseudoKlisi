function mov = plot_animation(parameters,footshape,results,plot_misc)
    figure(1)
    ...
    alfa=parameters.alfaA;   g=parameters.g;
...
%         subplot(2,1,1)
    ...
    %    coordinates in Xa Ya system
     ...
     %   Center of foot 2  
        ...
        yM_plot=[yM_plot; yaM];  
        %Mass Counterweight
        xamcw=xH_i+rcw*cos(thetaD_i);
        yamcw=yH_i+rcw*sin(thetaD_i);
        %Mass m1U
        ...
        %Kormos
        xcw=xH_i+Rcw*cos(thetaD_i);
        ycw=yH_i+Rcw*sin(thetaD_i);
        %CoM
        xamcom=(xaM*M+xamcw*mcw+xam1U*m1F+xam1B*m1T+xam2U*m2F+xam2B*m2T)/10;
        yamcom=(yaM*M+yamcw*mcw+yam1U*m1F+yam1B*m1T+yam2U*m2F+yam2B*m2T)/10;
        %Knee 1
    ...
    %    Center of rocker 1
        ...
        %Counterweight
        [xmcw,ymcw]=rotate_coord(xamcw,yamcw,alfa);
        %Mass m1U
        ...
        %Com
        [xcom,ycom]=rotate_coord(xamcom,yamcom,alfa);
        %Knee 1
      ...
      %  Rocker circle
        ...
        %Line Rcw
        line_Rcw=line([xM,xcw],[yM,ycw],'Color',[50 205 50]/255,'LineWidth',2);
       % Mass M
        massM_obj=plot(xM,yM,'o','LineWidth',0.5,'MarkerFaceColor',[0 0 102]/255,'MarkerEdgeColor','w','MarkerSize',8);
        %Mass mcw
        massmcw_obj=viscircles([xmcw,ymcw],0.01,'Color',[50 205 50]/255);
        %Mass m1U
        ...
        %CoM
        masscom_obj=viscircles([xcom,ycom],0.01,'Color',[50 205 50]/255);
