...
M=parameters.M;
m1F=parameters.m1F;     m1T=parameters.m1T;     m2F=parameters.m2F;     m2T=parameters.m2T;     mcw=parameters.mcw;

I=parameters.I;
I1F=parameters.I1F;     I1T=parameters.I1T;     I2F=parameters.I2F;     I2T=parameters.I2T;     Icw=parameters.Icw;

L1F=parameters.L1F;     L1T=parameters.L1T;     L2F=parameters.L2F;     L2T=parameters.L2T;     rcw=parameters.rcw;
...
xH=results.xH;
yH=results.yH;
thetaD=results.thetaD;
thetaD_d=results.thetaD_d;
%%

%Kinetic energy
K=Kinetic_energy(I1F,I2F,I1T,I2T,Icw,L1F,L2F,M,ksiF,ksiT,l1,l2,l3,l4,l5,l6,l1F,l2F,l1T,l2T,l1Tx,l2Tx,m1F,m2F,m1T,m2T,mcw,psiF,psiK,psiF_d,psiK_d,rcw,thetaD,thetaF,thetaK,thetaD_d,thetaF_d,thetaK_d,xH_d,yH_d);
%plot(results.t,K)

%Potential energy
Ug = Potential_energy(L1F,L2F,M,g,ksiF,ksiT,l1,l2,l3,l4,l5,l6,l1F,l2F,l1T,l2T,l1Tx,l2Tx,m1F,m2F,m1T,m2T,mcw,psiF,psiK,rcw,thetaD,thetaF,thetaK,yH);
