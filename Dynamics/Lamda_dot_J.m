...
Ldot(3,1)=Ld31(L1T,ksiF,ksiT,l1,l2,l3,l4,l5,thetaF,thetaK,thetaF_d,thetaK_d)-thetaT_d*(ddxc1_ddth*dthT_dthK)-dxc1_dth*ddthT_ddthK*thetaK_d;
Ldot(3,2)=Ld32(L1T,ksiF,ksiT,l1,l2,l3,l4,l5,thetaF,thetaK,thetaF_d,thetaK_d)-thetaT_d*(ddyc1_ddth*dthT_dthK)-dyc1_dth*ddthT_ddthK*thetaK_d;
Ldot(3,3)=Ld33;
Ldot(3,4)=Ld34;

Ldot(4,1)=Ld41;
Ldot(4,2)=Ld42;
Ldot(4,3)=Ld43(L2T,ksiF,ksiT,l1,l2,l3,l4,l5,psiF,psiK,psiF_d,psiK_d)-psiT_d*(ddxc2_ddps*dpsT_dpsK)-dxc2_dps*ddpsT_ddpsK*psiK_d;
Ldot(4,4)=Ld44(L2T,ksiF,ksiT,l1,l2,l3,l4,l5,psiF,psiK,psiF_d,psiK_d)-psiT_d*(ddyc2_ddps*dpsT_dpsK)-dyc2_dps*ddpsT_ddpsK*psiK_d;

Ldot(5,1)=Ld51(L1F,L1T,ksiF,ksiT,l1,l2,l3,l4,l5,l6,thetaF,thetaK,thetaF_d,thetaK_d)-thetaT_d*(ddxc1_ddth*dthT_dthF)-dxc1_dth*ddthT_ddthF*thetaF_d;
Ldot(5,2)=Ld52(L1F,L1T,ksiF,ksiT,l1,l2,l3,l4,l5,l6,thetaF,thetaK,thetaF_d,thetaK_d)-thetaT_d*(ddyc1_ddth*dthT_dthF)-dyc1_dth*ddthT_ddthF*thetaF_d;
Ldot(5,3)=Ld53;
Ldot(5,4)=Ld54;

Ldot(6,1)=Ld61;
Ldot(6,2)=Ld62;
Ldot(6,3)=Ld63(L2F,L2T,ksiF,ksiT,l1,l2,l3,l4,l5,l6,psiF,psiK,psiF_d,psiK_d)-psiT_d*(ddxc2_ddps*dpsT_dpsF)-dxc2_dps*ddpsT_ddpsF*psiF_d;
Ldot(6,4)=Ld64(L2F,L2T,ksiF,ksiT,l1,l2,l3,l4,l5,l6,psiF,psiK,psiF_d,psiK_d)-psiT_d*(ddyc2_ddps*dpsT_dpsF)-dyc2_dps*ddpsT_ddpsF*psiF_d;
